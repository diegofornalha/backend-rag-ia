...
class EmbateAgent(GeminiAgent):
    ...
    PALAVRAS_CHAVE_EMBATE = [
        "compare", "analise", "debata", "discuta",
        "avalie", "critique", "confronte", "versus",
        "pros e contras", "vantagens e desvantagens",
        "melhor opção", "diferenças", "semelhanças"
    ]
    ...
    def _validar_parametros(self, dados: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            assert 0 <= dados["parametros"]["temperatura"] <= 1, "Temperatura deve estar entre 0 e 1"
