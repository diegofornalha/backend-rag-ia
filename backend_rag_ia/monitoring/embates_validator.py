...
class EmbatesValidator:
    ...
    def add_rule(self, name: str, validation_fn: callable, 
                error_message: str, severity: str) -> None:
    ...
    def _validate_metadata(self, embate_data: Dict) -> bool:
        ...
        return (
            metadata['impacto'] in valid_impactos and
            metadata['prioridade'] in valid_prioridades and
