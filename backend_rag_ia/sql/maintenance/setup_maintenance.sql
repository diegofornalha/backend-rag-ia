...
BEGIN
    DELETE FROM "01_base_conhecimento_regras_geral"
...
DECLARE
    deleted_count integer;
BEGIN
    DELETE FROM "02_embeddings_regras_geral" e
    WHERE NOT EXISTS (
        SELECT 1
...
DROP TRIGGER IF EXISTS trigger_update_timestamp ON "01_base_conhecimento_regras_geral";
CREATE TRIGGER trigger_update_timestamp
    BEFORE UPDATE ON "01_base_conhecimento_regras_geral"
    FOR EACH ROW
