...
def resolver_problema_deploy(descricao_problema: str, similaridade_minima: float = 0.3, limite: int = 5):
    """
    ...
    try:
        ...
        console.print("1. Certifique-se que todos os arquivos de configuração estão na raiz do projeto")
